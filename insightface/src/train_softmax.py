...
def parse_args():
  ...
  # general
  parser.add_argument('--data-dir', default='F:/FaceData/faces_umd/', help='training set directory')
  ...
  parser.add_argument('--network', default='m1', help='specify network')
