...
from data import cfg_mnet, cfg_re50,test_fddb_args

from layers.functions.prior_box import PriorBox,PriorBox1

from models.retinaface import RetinaFace,FaceBoxes
...
def img(path):
    #img = detect(path)
    dets,path = detect(path)
    img = Mes_img(dets,path)
    # cv2.imshow("ccc",img)
